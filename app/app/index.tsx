      ...
      {tab === 'discover' && (
        <View style={styles.panel}>
          ...
          <View style={styles.ctaRow}>
            <Link href={routes.help.index()} asChild>
              <TouchableOpacity style={styles.ctaButton}>
                <Text style={styles.ctaButtonText}>Get help</Text>
              </TouchableOpacity>
            </Link>
      ...
      {tab === 'stay' && (
        <View style={styles.panel}>
          ...
          <View style={styles.grid}>
            {CATEGORIES.map((cat) => (
              <Link key={cat.slug} href={routes.help.withCategory(cat.slug)} asChild>
          ...
          {regions.length > 0 && (
            <>
              ...
              {regions.map((r) => (
                <Link key={r.id} href={routes.region.root(r.slug)} asChild>
