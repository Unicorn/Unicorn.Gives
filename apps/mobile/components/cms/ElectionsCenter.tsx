  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.background }} contentContainerStyle={{ padding: spacing.lg, paddingBottom: 40 }}>
      <View style={{ paddingTop: 10, paddingBottom: 8 }}>
        <View style={{ alignSelf: 'flex-start', backgroundColor: colors.primaryContainer, borderRadius: radii.pill, paddingHorizontal: 14, paddingVertical: 6, marginBottom: spacing.md }}>
          <Text style={{ color: colors.neutral, fontFamily: fonts.sansBold, fontSize: 12, letterSpacing: 0.5 }}>Election Center</Text>
        </View>
        ...
        <Text style={{ fontSize: 15, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 22, marginBottom: 14 }}>
      ...
      <View>
        <ImageBackground source={heroImage} style={{ height: 240, borderRadius: radii.lg, overflow: 'hidden', justifyContent: 'flex-end' }} resizeMode="cover">
          <View style={{ position: 'absolute', right: 12, bottom: 12, left: 12, backgroundColor: 'rgba(0,0,0,0.35)', borderRadius: 14, padding: 14 }}>
            <Text style={{ color: colors.onHeroBar, fontFamily: fonts.sansBold, fontSize: 15, marginBottom: 6 }}>"A citizen's voice is the heartbeat of the township."</Text>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: spacing.md }}>
          <View style={{ flex: 1, backgroundColor: colors.background, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.surfaceContainer }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>By Mail or Online</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>Must be completed at least 15 days prior to the election.</Text>
            <TouchableOpacity
              style={{ paddingVertical: 10, paddingHorizontal: 12, borderRadius: radii.md, marginTop: 4, borderWidth: 1, borderColor: colors.heroBar, backgroundColor: colors.background }}
              onPress={() => Linking.openURL('https://mvic.sos.state.mi.us/')}
            >
          ...
          <View style={{ flex: 1, backgroundColor: colors.background, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.surfaceContainer }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>In Person</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>Registration is available at the Clerk's Office up to and including Election Day with proof of residency.</Text>
            <TouchableOpacity
              style={{ paddingVertical: 10, paddingHorizontal: 12, borderRadius: radii.md, marginTop: 4, borderWidth: 1, borderColor: colors.heroBar, backgroundColor: colors.background }}
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: spacing.md, marginTop: spacing.sm }}>
          <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>No-Reason Absentee Voting</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20 }}>
          ...
          <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>Returning Your Ballot</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20 }}>
      ...
      >
        ...
        <View style={{ gap: spacing.md, flexDirection: 'row' }}>
          <View style={{ flex: 1, borderRadius: 14, padding: 14, borderWidth: 1, backgroundColor: colors.surface, borderColor: colors.outline }}>
            <Text style={{ fontSize: 12, fontFamily: fonts.sansBold, color: colors.neutralVariant, marginBottom: 4 }}>15 Days Before</Text>
            <Text style={{ fontSize: 14, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 8 }}>Online Registration Cutoff</Text>
            <Text style={{ fontSize: 13, lineHeight: 20, fontFamily: fonts.sans, color: colors.neutral }}>
              Registration by mail or online ends. In-person registration still available at the Clerk's Office.
            </Text>
          </View>
          <View style={{ flex: 1, borderRadius: 14, padding: 14, borderWidth: 1, backgroundColor: colors.heroBar, borderColor: colors.heroBar }}>
            <Text style={{ fontSize: 12, fontFamily: fonts.sansBold, color: colors.gold, marginBottom: 4 }}>Friday Before</Text>
            <Text style={{ fontSize: 14, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 8 }}>Mail Ballot Deadline</Text>
            <Text style={{ fontSize: 13, lineHeight: 20, fontFamily: fonts.sans, color: colors.neutral }}>
              5:00 PM: Last day to request an absentee ballot be mailed to you.
            </Text>
          </View>
          <View style={{ flex: 1, borderRadius: 14, padding: 14, borderWidth: 1, backgroundColor: colors.surface, borderColor: colors.outline }}>
            <Text style={{ fontSize: 12, fontFamily: fonts.sansBold, color: colors.neutralVariant, marginBottom: 4 }}>Election Day</Text>
            <Text style={{ fontSize: 14, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 8 }}>Polls Open</Text>
            <Text style={{ fontSize: 13, lineHeight: 20, fontFamily: fonts.sans, color: colors.neutral }}>
      ...
      <View style={{ marginTop: spacing.lg, borderRadius: radii.lg, overflow: 'hidden' }}>
        <ImageBackground source={electionsCommunity} style={{ height: 260, justifyContent: 'flex-end' }} resizeMode="cover">
          ...
          <View style={{ padding: spacing.lg, gap: 10 }}>
            <Text style={{ color: colors.onHeroBar, fontFamily: fonts.sansBold, fontSize: 20 }}>Serve Your Community</Text>
            <Text style={{ color: colors.onHeroBar, fontFamily: fonts.sans, fontSize: 14, lineHeight: 22 }}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginTop: 10, gap: spacing.md }}>
          <View style={{ flexBasis: '48%', backgroundColor: colors.background, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>Michigan Voter Information Center</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>Check registration, view sample ballots, and find your polling location.</Text>
            <TouchableOpacity onPress={() => Linking.openURL('https://mvic.sos.state.mi.us/')} style={{ paddingVertical: 4 }}>
              <Text style={{ color: colors.primary, fontFamily: fonts.sansBold }}>mvic.sos.state.mi.us →</Text>
            </TouchableOpacity>
          </View>

          <View style={{ flexBasis: '48%', backgroundColor: colors.background, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>Secretary of State</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>Voter registration, election information, and absentee voting details.</Text>
            <TouchableOpacity onPress={() => Linking.openURL('https://www.michigan.gov/sos')} style={{ paddingVertical: 4 }}>
              <Text style={{ color: colors.primary, fontFamily: fonts.sansBold }}>michigan.gov/sos →</Text>
            </TouchableOpacity>
          </View>

          <View style={{ flexBasis: '48%', backgroundColor: colors.background, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>Clare County Clerk</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>County elections office: voter registration, sample ballots, and election results.</Text>
            <TouchableOpacity onPress={() => Linking.openURL('http://clareclerkrod.com/')} style={{ paddingVertical: 4 }}>
              <Text style={{ color: colors.primary, fontFamily: fonts.sansBold }}>clareclerkrod.com →</Text>
            </TouchableOpacity>
          </View>

          <View style={{ flexBasis: '48%', backgroundColor: colors.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.outline }}>
            <Text style={{ fontSize: 15, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 6 }}>Township Clerk</Text>
            <Text style={{ fontSize: 13, fontFamily: fonts.sans, color: colors.neutral, lineHeight: 20, marginBottom: 10 }}>Carol Majewski</Text>
            <TouchableOpacity onPress={() => Linking.openURL('tel:989-588-9069')} style={{ paddingVertical: 4 }}>
              <Text style={{ color: colors.primary, fontFamily: fonts.sansBold }}>989-588-9069</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => Linking.openURL('mailto:clm@lincolntwp.com')} style={{ paddingVertical: 4 }}>
      ...
      {pageBody ? (
        <View style={{ marginTop: spacing.lg, backgroundColor: colors.surface, borderRadius: radii.lg, padding: spacing.lg, borderWidth: 1, borderColor: colors.outline }}>
          <Text style={{ fontSize: 20, fontFamily: fonts.sansBold, color: colors.neutral, marginBottom: 10 }}>Elections & Voting Information</Text>
          <MarkdownRenderer content={pageBody} />
        </View>
      ) : null}

      {variant !== 'full' ? (
        <Text style={{ textAlign: 'center', paddingVertical: 18, fontFamily: fonts.sans, color: colors.neutralVariant }}>Preview mode is enabled.</Text>
      ) : null}
    </ScrollView>
  );
}
