...
export default function ContactsRedirect() {
  ...
  const target = `/county/${COUNTY_SLUG}/townships/${TOWNSHIP_SLUG}/contacts`;
  ...
  return (
    <View style={styles.c}>
      <Text style={styles.t}>Redirecting to Contact Directory…</Text>
      <Link href={target} asChild>
        <TouchableOpacity style={styles.link} activeOpacity={0.85}>
          <Text style={styles.linkText}>Open directory</Text>
        </TouchableOpacity>
      </Link>
    </View>
  );
